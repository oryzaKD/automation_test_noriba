...
describe('Request Limit', () => {
  ...
  it("Input Data Pribadi", async () => {
    ...
    await $('//android.widget.ScrollView/android.widget.EditText[1]').setValue("0")
    await $('//android.widget.ScrollView/android.widget.EditText[2]').setValue("Siti Aminah")
    ...
    await $('//android.view.View[@content-desc="Kakak"]').click()

    await $('//android.widget.ScrollView/android.widget.EditText[1]').click()
    await $('//android.widget.ScrollView/android.widget.EditText[1]').setValue("Andi Soraya")

    await $('//android.widget.ScrollView/android.widget.EditText[2]').click()
    await $('//android.widget.ScrollView/android.widget.EditText[2]').setValue("0300392030202")
    ...
    await $('//android.view.View[@content-desc="Pilih Jenis Barang yang Dibeli"]').click()
    await $('//android.view.View[@content-desc="Elektronik"]').click()
  })
